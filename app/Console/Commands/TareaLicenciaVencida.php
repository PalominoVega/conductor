...
class TareaLicenciaVencida extends Command
{
    /**
    ...
    public function handle()
    {
        ...
        $vencidos=Vehiculo::with('empresa')->where('fecha_licencia',$prevent)
                ->get();
            ...
            'notification'=>array(
                ...
                'body'=>("Licencia por VENCER del vehiculo placa ").$vencido->placa,
